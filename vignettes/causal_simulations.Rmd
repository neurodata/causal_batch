...
In this simulation, we will generate a sigmoidal simulation with $n=200$ samples, where the samples have an equal probability of being from each group/batch.

```{r, fig.width=5, fig.height=3}
sim = cb.sims.sim_sigmoid(n=n)

plot.sim(sim$Y, sim$Batch, sim$X, title="Sigmoidal Simulation")
```
...
```{r, fig.width=5, fig.height=3}
plot.sim.expected(sim$Y, sim$Batch, sim$X,
...
plot.sim(sim$Y, sim$Batch, sim$X, 
